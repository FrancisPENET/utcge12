...
Pour cette carte, nous avons utilisé la base de données Siren, en nous concentrant sur
les entreprises situées à Saint-Nazaire et relevant principalement des secteurs
ouvriers, ceux-ci étant surreprésentés dans la région.
La base étant trop volumineuse pour être traitée directement dans Magrit sous forme
de points, nous avons utilisé ChatGPT pour agréger les entreprises par carrés de 200 m
x 200 m. Une fois les données simplifiées, nous avons pu créer une carte lissée.
Nous avons choisi d’utiliser la méthode de potentiel de Stewart, qui offre une meilleure
représentation à cette échelle que la méthode de densité de noyaux.
Ensuite, nous avons récupéré sur le site saintnazaireagglo.fr la localisation des
établissements d’enseignement supérieur, que nous avons associés au réseau des
routes de la ville à partir de leurs adresses.
Enfin, nous avons collecté manuellement sur le site du pôle EMC2 les adresses des
entreprises membres du pôle ayant leur siège social à Saint-Nazaire.

Limites de la carte

La carte ne tient compte que des entreprises situées à Saint-Nazaire, alors que le pôle
industriel s’étend sur plusieurs communes voisines, comme Montoir-de-Bretagne, qui
accueille le port de commerce et l’aéroport, deux infrastructures majeures.
De plus elle ne représente pas les entreprises membres de EMC2 possédant seulement
une usine de production par exemple.
...
Construction cartographique : Cette carte, issus de nos travaux en TD de GE12, représente la croissance économique (en pourcentage d’évolution du PIB) des régions françaises entre 2015 et 2022. Elle permet donc de souligner, le dynamisme économique de la région des Pays de la Loire par rapport au reste de la France. L’utilisation d’une carte chloroplète s’explique par la nature des données : un ratio (pourcentage).


L’économie de la Loire-Atlantique est portée par un tissu économique très divers. Contrairement à d’autres départements très spécialisés, comme le nord de la France, très industriel, et qui fait face au retrait de ces activités, la Loire-Atlantique est aujourd’hui très dynamique, tout comme la région des Pays-de-la-Loire. Ainsi, la croissance économique de la région y est plus importante que la moyenne nationale (carte ci-dessous).

![](https://i.postimg.cc/pTvj2gzn/export.png)


Construction cartographique : Nous avons utilisé une base de données de l’Observatoire, qui indique le nombre de travailleurs par secteur dans cinq grands domaines d’activité.
Nous avons d’abord filtré ces données pour ne conserver que celles concernant le département de la Loire-Atlantique.
Ensuite, nous avons calculé la part moyenne de chaque secteur à l’échelle régionale. À partir du nombre total de travailleurs par commune, nous avons estimé combien chaque secteur devrait compter de travailleurs si la commune suivait la moyenne régionale.
Nous avons ensuite comparé ces valeurs estimées aux données réelles de chaque commune en calculant un ratio (valeur réelle / valeur théorique). La commune a ensuite été classée dans le secteur où ce ratio est le plus élevé

Limites : Cette méthode ne permet pas de visualiser la possible surreprésentation d’autres
secteurs secondaires dans une même commune.
Elle ne distingue pas bien une commune très proche de la moyenne régionale d’une autre qui est fortement atypique.

Ainsi, le système productif du département regroupe tous les types d’activités, parmi lesquelles :
- Le secteur industriel, notamment tourné vers l’industrie maritime autour de l’estuaire de la Loire (Partie 2), mais aussi composé d’autres sites industriels majeurs répartis sur l’ensemble du département (raffinerie, industrie agro-alimentaire…).
- Les espaces ruraux et peu densément peuplées, sont propices aux activités agricoles, particulièrement dans le nord du département., comme on le voit sur la carte. L’agriculture est aussi diverse : viticulture, maraîchage, céréales, élevage bovin…
- La côte du département, à l’exception du pôle industriel de St Nazaire, est majoritairement dédiée aux activités touristiques balnéaires.
- Le centre de l’agglomération nantaise concentre les emplois de cadre et de professions intellectuelles supérieures.


![](https://i.postimg.cc/76RHjxv1/Tourisme.png)

Construction cartographique : 
Cette carte permet de distinguer les centres touristiques majeurs du département, notamment en visualisant la densité des hôtels. On distingue donc bien deux zones : Nantes et la côte. De même, la carte choroplèthe (ratio) de la proportion de résidences secondaires, traduit un attrait pour la zone littorale : les citadins recherchent un lieu pour se détendre près de l’océan. L’ajout des principales infrastructures de transports permet de montrer l’intégration de ces haut-lieux au reste du département et du pays. 

Le département de la Loire-Atlantique accueille un secteur touristique très développé, qui réalise un chiffre d'affaires annuel de plus de 3 milliards d’euros. Il emploie près de 30 000 personnes, un chiffre en augmentation (+10% en 10 ans).
Il se structure en deux pôles majeurs. 
- La côte du département, qui repose sur de nombreuses stations balnéaires d’envergure nationale comme la Baule, Pornic ou le Croisic. Prisées pour leurs plages ensablées et un climat agréable. Il y existe un grand nombre de structures pour l’accueil des touristes, notamment des hôtels. De plus, ces villes côtières sont fortement connectées à l’intérieur des terres avec des liaisons ferrées avec Nantes et même des liaisons à grande vitesse entre Paris, La Baule et le Croisic, renforçant l’attractivité touristique de ces stations. Aussi, elles concentrent la majorité des résidences secondaires.
- Nantes, par son statut de grande agglomération, attire un tourisme plus culturel, avec des musées, les machines de l’île, son centre historique, par exemple, le château des ducs de Bretagne, à Nantes, a accueilli plus d’un million de visiteurs en 2022.
...
La Loire-Atlantique se distingue par une croissance démographique soutenue, principalement polarisée autour de l'agglomération nantaise, qui attire une population diverse grâce à son réseau d'enseignement supérieur, son économie dynamique et sa qualité de vie. Cette attractivité s'accompagne cependant d'une hausse des prix de l'immobilier, exacerbant les inégalités d'accès au logement.

Le complexe industrialo-portuaire de Nantes-Saint-Nazaire joue un rôle crucial dans l'économie locale, générant des emplois et des richesses, mais faisant face à des défis environnementaux majeurs. Les efforts de transition énergétique, bien que prometteurs, nécessitent des solutions structurelles et sociétales pour être pleinement efficaces.

L'économie de la Loire-Atlantique est diversifiée, avec des secteurs industriels, agricoles, touristiques et de services bien développés. Cette diversification contribue à une croissance économique supérieure à la moyenne nationale, tout en présentant des disparités internes, notamment entre les zones côtières attractives et les régions plus rurales et moins connectées.

Limites du Travail

Notre analyse présente plusieurs limites. Tout d'abord, les données utilisées peuvent ne pas être exhaustives et certaines représentations cartographiques simplifient la réalité territoriale. De plus, notre étude s'est concentrée sur certains aspects économiques et démographiques, laissant de côté d'autres dimensions potentielles comme une analyse plus approfondie des inégalités sociales ou des impacts environnementaux détaillés.
Réflexion sur les Méthodes

L'utilisation du logiciel de cartographie thématique Magrit a été essentielle pour visualiser et analyser les données géographiques. Cependant, la manipulation de grandes bases de données et la simplification des informations pour les rendre cartographiables ont parfois limité la précision de nos représentations. L'intégration de données supplémentaires et l'utilisation de méthodes de lissage plus avancées pourraient améliorer la qualité des analyses futures.

Perspectives

Ce projet a mis en lumière l'importance de l'aménagement du territoire et des politiques de développement local pour répondre aux enjeux économiques et sociaux. Il serait intéressant d'approfondir l'étude des disparités spatiales et des solutions pour une transition énergétique efficace, en intégrant des approches participatives et des analyses multicritères.

En conclusion, ce travail a été une opportunité enrichissante pour appliquer les concepts de géographie économique à un territoire spécifique, tout en développant des compétences en analyse spatiale et en cartographie thématique. Les résultats obtenus ouvrent la voie à des recherches futures plus approfondies et nuancées sur les dynamiques territoriales de la Loire-Atlantique. 